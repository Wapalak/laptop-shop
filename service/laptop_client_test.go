...
func TestClientCreateLaptop(t *testing.T) {
	...
	serverAddress := startTestLaptopService(t, laptopStore, nil, nil)
...
func startTestLaptopService(t *testing.T, laptopStore service.LaptopStore, imageStore service.ImageStore,
...
func TestClientUploadImage(t *testing.T) {
	...
	serverAddress := startTestLaptopService(t, laptopStore, imageStore, nil)
	laptopClient := newTestLaptopClient(t, serverAddress)
...
func TestClientRateLaptop(t *testing.T) {
	...
	serverAddress := startTestLaptopService(t, laptopStore, nil, ratingStore)
	laptopClient := newTestLaptopClient(t, serverAddress)
	...
	for idx := 0; ; idx++ {
		...
		require.Equal(t, uint32(idx+1), res.RatedCount)
		require.Equal(t, expected[idx], res.GetAverageScore())
	}
}

// НАДО ПОНЯТЬ В ЧЕМ ОШИБКА
...
//		MinCpuCores: 4,
//		MinCpuGhz:   2.2,
//		MinRam:      &pb.Memory{Value: 4, Unit: pb.Memory_GIGABYTE},
//	}
//
//	laptopStore := service.NewInMemoryLaptopStore()
//	expectedIDs := make(map[string]bool)
...
//
//	}
//	serverAddress := startTestLaptopService(t, laptopStore, nil)
//	laptopClient := newTestLaptopClient(t, serverAddress)
//
//	req := &pb.SearchLaptopRequest{Filter: filter}
//	stream, err := laptopClient.SearchLaptop(context.Background(), req)
